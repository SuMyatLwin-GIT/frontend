...
const EngineerList = () => {
  ...
  const getAll = async (buttonId:any) => {
          ...
          <div className= 'flex-submit'>
            ...
            <div>
              <Button type="submit" className="button-text" 
                onClick={() => {setButtonClick('search');}}>検索</Button>
            </div>
            <div>
              <Button type="reset" onClick={() => getAll('getall')} className="button-text">全て検索</Button>
            </div>
          </div>
        </Form>
      </div>
